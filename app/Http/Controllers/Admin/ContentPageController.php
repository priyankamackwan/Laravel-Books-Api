...
class ContentPageController extends Controller
{
    ...
    {
        $contentPage = $request->all();
        $contentPage['slug'] = str_replace(" ", "-", strtolower($request->title));
    ...
    {
        $contentPages = $request->all();
        $contentPages['slug'] = str_replace(" ", "-", strtolower($request->title));
        $contentPage->update($contentPages);
        $contentPage->categories()->sync($request->input('categories', []));
        $contentPage->tags()->sync($request->input('tags', []));
        if ($request->input('featured_image', false)) {
